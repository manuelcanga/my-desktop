...
final class User_Agent {
	 ...
	 * @param string  $http_user_agent Specfiic user agent string to check.
	 *
	 * @return array
	 *
	 */
	...
	private function is_tablet( string $http_user_agent ): bool
	{
		...
		$is_kinle = strpos( $http_user_agent, 'Kindle' ) !== false;
		$is_ipad = strpos( $http_user_agent, 'iPad' ) !== false;

		return ( $is_tablet || $is_android_tablet || $is_android_tablet || $is_kinle || $is_ipad );
	}
