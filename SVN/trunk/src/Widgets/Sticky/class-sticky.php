...
abstract class Sticky extends Widget {
     ...
     *
     * @paraam integer $user_id Widget owner.
     *
     * @return boolean
     */
    public function save_localization( array $widget_localization, int $user_id = 0 )
    {
     ...
     * @return array
     */
    private function sanitize_widget( array $widget_data, array $saved_widget )
    {
        $widget = $saved_widget;
