...
class Desktop extends Widget {
    ...
    private const   JS_ASSETS = [
        ...
        PLUGIN_URL . '/assets/js/base/jquery2.min.js',
        PLUGIN_URL . '/assets/js/base/jquery-ui.min.js',
    ...
    public function show(): void
    {
        ...
        $vars = [
            ...
            'js_assets'          => WP_Hooks::apply_filters( PLUGIN_NAME . '/js_assets', self::JS_ASSETS ),
    ...
    /**
     * Retrive localized weekdays.
     *
     * @return string;
     */
    private function get_weekdays(): string
    {
        return json_encode( array_values( $GLOBALS[ 'weekday_abbrev' ] ) );
    }
